                            ...
                            while ($row = $result_procesados->fetch_assoc()) {
                                ...
                                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="../archivos/vaucher/<?= $row['archivoVaucher'] ?>" target="_blank"
                                                class="btn btn-danger btn-sm   <?= (empty($row['archivoVaucher']) ? 'disabled' : '') ?>"
                                        ...
                                        <td>
                                            <input type="file" name="fileInput" id="fileInput" multiple accept=".pdf"
                                                class="form-control" required="">
                                        </td>
                                        <td>
                                            <input type="hidden" name="idMatricula" value="<?= $row['idMatricula'] ?>">
                                            <input type="submit" name="guardarVaucher" value="Enviar"
